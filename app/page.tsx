              ...
              <div className="flex flex-col items-center gap-3 pt-6 animate-fade-in-up delay-200">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="group relative flex flex-col items-center gap-1">
                    ...
                    <span className="text-xs font-medium text-gray-500 group-hover:text-[#25D366] transition-colors">WhatsApp (Soon)</span>
                  </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-5xl mx-auto">
              ...
              <div className="relative flex flex-col items-center text-center space-y-4">
                ...
                <p className="text-gray-600">Relax! We'll send you an instant alert via Telegram or Email (WhatsApp coming soon).</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="relative flex flex-col p-8 bg-white border-2 border-blue-600 rounded-2xl shadow-xl scale-105 z-10">
                ...
                <ul className="space-y-4 mb-8 flex-1">
                  ...
                  <li className="flex items-center text-gray-600">
                    <CheckCircle2 className="h-5 w-5 text-blue-600 mr-3" />
                    Priority Telegram alerts (WhatsApp soon)
                  </li>
                  <li className="flex items-center text-gray-600">
                    <CheckCircle2 className="h-5 w-5 text-blue-600 mr-3" />
