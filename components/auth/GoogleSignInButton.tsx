...
export function GoogleSignInButton() {
    ...
    return (
        <Button
            ...
            variant="outline"
            className="w-full flex items-center justify-center gap-2 py-6 text-base font-medium border-slate-300 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-900 transition-all shadow-sm"
        >
